...
function cookie_store_remove(domain) {
    console.log("APPU DEBUG: Cleaning cookie store of: " + domain);
    delete_from_local_storage("CookieStore:" + domain);
}
...
function cookie_investigator(account_cookies, 
    ...
    var next_binary_cs = undefined;
    var next_decimal_cs = undefined;
    var next_gub_binary_cs = undefined;
    var next_gub_decimal_cs = undefined;
...
function test_comcast_cookie_set(val) {
    var a = new Date();
