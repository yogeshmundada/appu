// YHM: I took this library from https://github.com/oncletom/tld.js (for Node.js),
// broke it apart, and chose only few parts that were required for extracting eTLD.
// Future work: Use requirejs to load this library.
// Add a function to check if Public suffix library at Mozilla has changed.

var tld_module = (function() {
    "use strict";
     ...
     */
    function tld (){
	this.rules = $.parseJSON(read_tld_rules("thirdparty/tld/rules.json"));
    }
    
    function read_tld_rules(rules_path) {
	var url = chrome.extension.getURL(rules_path);
